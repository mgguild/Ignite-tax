    ...
    <section
      ...
      className="flex sm:pl-16 pl-1 sm:pr-16 pr-1 py-24 mt-6  flex-col md:flex-row bg-gradient-to-br from-blue-200 to-pink-300 border-8 border-white ">
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <p className="mb-4">Your privacy is important to us. It is IgniteTaxAI's policy to respect your privacy regarding any information we may collect from you across our website, https://ignitetax.ai, and other sites we own and operate.</p>
            ...
            <p className="mb-4">This policy is effective as of May 2025.</p>
        </div>
        </div>
    </section>
  );
